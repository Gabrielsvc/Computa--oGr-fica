...
#include "../teste/janelaprincipal.h"
...
const QMetaObjectExtraData JanelaPrincipal::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject JanelaPrincipal::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_JanelaPrincipal,
      qt_meta_data_JanelaPrincipal, &staticMetaObjectExtraData }
};
